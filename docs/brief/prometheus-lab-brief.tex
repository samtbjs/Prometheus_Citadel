...
\hypersetup{
  ...
  pdftitle={Prometheus Lab: a team brief},
...
\pagestyle{fancy}
\fancyhf{}
\lhead{\sffamily\small\bfseries\color{Coral}PROMETHEUS LAB}
...
the wrong method beside the right one, and an everyday analogy. Gemma reads what
...
is left on your exact idea, Gemma writes one --- modelled on the question you
...
check questions used, or the model-call budget reached. Gemma cannot summon him,
...
come back. Gemma writes that line from the facts code assembles; it is told not
...
tried and in what order, how many follow-ups you got right. Gemma turns that
