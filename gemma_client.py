"""
gemma_client.py  —  THE ONE DOOR TO THE MODEL.

Everywhere the app needs AI, it calls ask_gemma(). The model is OpenAI's
...
crashing. Function names (ask_gemma, gemma_available, ...) are kept as-is so
